...
enum ShapeshiftForm
{
    ...
    AVATAR_BEAR_ELUNE_BLUE  = 0x2A,
    AVATAR_BEAR_ELUNE_GREEN = 0x2B,
    AVATAR_BEAR_ELUNE_PURPLE= 0x2C,
    AVATAR_BEAR_ELUNE_RED   = 0x2D,
    AVATAR_CAT_ELUNE_BLUE   = 0x2E,
    AVATAR_CAT_ELUNE_GREEN  = 0x2F,
    AVATAR_CAT_ELUNE_PURPLE = 0x30,
    AVATAR_CAT_ELUNE_RED    = 0x31,
    AVATAR_BEAR_XAVIUS_BLUE = 0x32,
    AVATAR_BEAR_XAVIUS_BROWN= 0x33,
    AVATAR_BEAR_XAVIUS_GREEN= 0x34,
    AVATAR_BEAR_XAVIUS_RED  = 0x35,
    AVATAR_CAT_XAVIUS_BLUE  = 0x36,
    AVATAR_CAT_XAVIUS_GREEN = 0x37,
    AVATAR_CAT_XAVIUS_ORANGE= 0x38,
    AVATAR_CAT_XAVIUS_RED   = 0x39
};
