...
enum ShapeshiftForm
{
    ...
    AVATAR_BLUECHILD        = 0x28,
    AVATAR_ANSHE            = 0x29,
    AVATAR_URSOC_BLUE       = 0x2A,
    AVATAR_URSOC_GREEN      = 0x2B,
    AVATAR_URSOC_PURPLE     = 0x2C,
    AVATAR_URSOC_RED        = 0x2D,
    AVATAR_ASHAMANE_BLUE    = 0x2E,
    AVATAR_ASHAMANE_GREEN   = 0x2F,
    AVATAR_ASHAMANE_PURPLE  = 0x30,
    AVATAR_ASHAMANE_RED     = 0x31,
    AVATAR_URSOC_CORRUPTED_BLUE  = 0x32,
    AVATAR_URSOC_CORRUPTED_BROWN = 0x33,
    AVATAR_URSOC_CORRUPTED_GREEN = 0x34,
    AVATAR_URSOC_CORRUPTED_RED   = 0x35,
    AVATAR_ASHAMANE_CORRUPTED_BLUE   = 0x36,
    AVATAR_ASHAMANE_CORRUPTED_GREEN  = 0x37,
    AVATAR_ASHAMANE_CORRUPTED_ORANGE = 0x38,
    AVATAR_ASHAMANE_CORRUPTED_RED    = 0x39
};
