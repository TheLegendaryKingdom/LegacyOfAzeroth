...
enum ShapeshiftForm
{
    ...
    AVATAR_BEAR_ELUNE_BLUE  = 0x30,
    AVATAR_BEAR_ELUNE_GREEN = 0x31,
    AVATAR_BEAR_ELUNE_PURPLE= 0x32,
    AVATAR_BEAR_ELUNE_RED   = 0x33,
    AVATAR_CAT_ELUNE_BLUE   = 0x34,
    AVATAR_CAT_ELUNE_GREEN  = 0x35,
    AVATAR_CAT_ELUNE_PURPLE = 0x36,
    AVATAR_CAT_ELUNE_RED    = 0x37,
    AVATAR_BEAR_XAVIUS_BLUE = 0x38,
    AVATAR_BEAR_XAVIUS_BROWN= 0x39,
    AVATAR_BEAR_XAVIUS_GREEN= 0x3A,
    AVATAR_BEAR_XAVIUS_RED  = 0x3B,
    AVATAR_CAT_XAVIUS_BLUE  = 0x3C,
    AVATAR_CAT_XAVIUS_GREEN = 0x3D,
    AVATAR_CAT_XAVIUS_ORANGE= 0x3E,
    AVATAR_CAT_XAVIUS_RED   = 0x3F
};
